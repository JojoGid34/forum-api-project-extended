...
// --- [BARU] Import Repository Interfaces & Concrete ---
...
const ToggleLikeCommentUseCase = require('../Applications/use_case/LikeCommentUseCase');
...
container.register([
  ...
  // --- [BARU] Register Repository Threads, Comments, Replies ---
  {
...
container.register([
  ...
  // --- [BARU] Register Use Cases Threads, Comments, Replies ---
  {
