...
describe('ReplyRepositoryPostgres', () => {
  ...
  describe('verifyReplyOwner function', () => {
    it('should throw AuthorizationError when provided owner is not the reply owner', async () => {
      // Arrange
      await UsersTableTestHelper.addUser({ id: 'user-123' });
      await ThreadsTableTestHelper.addThread({ id: 'thread-123', owner: 'user-123' });
      await CommentsTableTestHelper.addComment({ id: 'comment-123', owner: 'user-123' });
    ...
    it('should not throw AuthorizationError when provided owner is the reply owner', async () => {
      // Arrange
      await UsersTableTestHelper.addUser({ id: 'user-123' });
      await ThreadsTableTestHelper.addThread({ id: 'thread-123', owner: 'user-123' });
      await CommentsTableTestHelper.addComment({ id: 'comment-123', owner: 'user-123' });
  ...
  describe('deleteReply function', () => {
    it('should delete reply from database (soft delete)', async () => {
      // Arrange
      await UsersTableTestHelper.addUser({ id: 'user-123' });
      await ThreadsTableTestHelper.addThread({ id: 'thread-123', owner: 'user-123' });
      await CommentsTableTestHelper.addComment({ id: 'comment-123', owner: 'user-123' });
  ...
  describe('getRepliesByThreadId function', () => {
    it('should return replies correctly', async () => {
      ...
      await RepliesTableTestHelper.addReply({
        id: 'reply-123', commentId: 'comment-123', content: 'sebuah balasan', owner: 'user-123', date: '2023-01-01',
      });

      const replyRepositoryPostgres = new ReplyRepositoryPostgres(pool, {});

      // Action
      // Note: Di sini kita ambil replies berdasarkan threadId dengan cara JOIN tabel comments
